...
<header class="navbar navbar-dark sticky-top bg-primary flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Lap Positioning</a>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php
                ...
                $queryMessage = $pdo->prepare("SELECT * FROM contactform");
                $queryMessage->execute();
                while ($dataMessage = $queryMessage->fetch()) {
            ?>
            <tr>
              <td><?=$dataMessage[0]?></td>
              <td><?=$dataMessage[1]?></td>
